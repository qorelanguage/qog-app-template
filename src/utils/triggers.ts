export const DEFAULT_TRIGGER_POLLING_INTERVAL = 30_000;
export const DEFAULT_TRIGGER_POLL_ITEM_LIMIT = 10;
export const DEFAULT_TRIGGER_SAVED_ITEMS_LIMIT_MAX = 100;
