...
import { getMondayBoardDependentOptions } from '../actions/helpers/get-board-dependent-options';
import { getMondayBoardIdAllowedValues } from '../actions/helpers/get-board-id-allowed-values';
import { getMondaySingleColumnAllowedValues } from '../actions/helpers/get-column-allowed-values';
...
import { getMondayRecordIdAllowedValues } from '../actions/helpers/get-record-id-allowed-values';
